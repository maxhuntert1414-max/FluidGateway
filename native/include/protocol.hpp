...
inline constexpr std::string_view native_version = "0.68.0";
inline constexpr std::string_view base_hash = "0d24d96aec32d74e123f9e198e51adde74ddf190e8c40b0ac18bddf5c4108b2f";
inline constexpr std::string_view batch_hash = "bf8727c22ac878ceff6dd0f462d6db5e81174737e839ecdf2e263a6f55268542";
struct Frame {
...
private:
    ...
    Frame respond(const Frame& request, std::uint8_t opcode, Bytes payload,
                  std::uint8_t decision = 0, bool ok = true) const;
